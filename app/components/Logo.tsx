...
export function Logo({ size = 60, color = "var(--color-wine)" }: { size?: number; color?: string }) {
  return (
    <svg
      width={size}
...
export const SplashLogo = memo(function SplashLogo({
  ...
  return (
    <div style={{ position: "relative", width: W, height: H }}>
      <svg width="100%" height="100%" viewBox="200 900 1600 950" fill="none" aria-hidden="true">
        <g transform="matrix(29.410967,0,0,29.410967,-18394.773466,-19109.067564)">
          <path
            d={LOGO_PATHS.M}
            pathLength="1"
